...
const ProjectCard = ({ project,onEdit }) => {
    return (
        <div className="group">
            <Link to={`/projectsDetails?id=${project._id}&tab=tasks`} className="bg-white dark:bg-zinc-950 dark:bg-gradient-to-br dark:from-zinc-800/70 dark:to-zinc-900/50 border border-gray-200 dark:border-zinc-800 hover:border-gray-300 dark:hover:border-zinc-700 rounded-lg p-5 transition-all duration-200">
                {/* Header */}
            ...
            className="mt-3 px-3 py-1 text-sm bg-blue-500 text-white rounded">
                Edit
            </button>
        </div>
    );
